...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n--De volgende is met getReleaseJaar (), ik wist niet of ik deze methode kon toevoegen-- \n");

        ArrayList nogNietInBezitmetrj = p1.bepaalGamesNietInBezitmetrj(teKoop);
        System.out.println("p1 heeft de volgende games nog niet: " + nogNietInBezitmetrj.toString());
    }
}